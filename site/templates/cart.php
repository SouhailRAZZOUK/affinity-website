...
<?php $products = $pages->find('shop/categories')->children()->visible() ?>
<?php snippet('header') ?>
...
<main id="cart" class="main" role="main">
	<div class="text">
		...
		<?php endif ?>
			...
			<div class="actions"><button class="button special" type="submit">Payer avec PayPal</button> ou <a class="button small" href="<?php echo url('shop') ?>">Continuer les achats</a></div>
		</form>
	</div>
</main>
